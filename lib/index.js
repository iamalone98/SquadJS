...
const discord = (state, options) => {
    ...
    return new Promise((res, rej) => {
        ...
        client.once('ready', () => {
            var _a;
            logger.log(`[Discord] Logged in as ${(_a = client.user) === null || _a === void 0 ? void 0 : _a.tag}`);
            res(true);
            state.discord = {
        ...
        coreListener.on(event, (data) => __awaiter(void 0, void 0, void 0, function* () {
            if (event === EVENTS.PLAYER_CONNECTED) {
                ...
                state.players = players
                    ? players.map((p) => p.steamID === player.steamID ? Object.assign(Object.assign({}, p), { ip: player.ip }) : p)
                    : [];
            }
